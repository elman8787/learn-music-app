...
class lesson3 : AppCompatActivity() {
    ...
    fun onclick(view: View) {
        ...
        if (button.text.toString() == "دو" && text == "1") {
            binding.textview.text = mylist.random()
            val player = MediaPlayer.create(this, R.raw.correctanswer)
            player.start()
            visible()
        } else if (button.text.toString() == "ر" && text == "2") {
            binding.textview.text = mylist.random()
            val player = MediaPlayer.create(this, R.raw.correctanswer)
            player.start()
            visible()
        } else if (button.text.toString() == "می" && text == "3") {
            visible()
            binding.textview.text = mylist.random()
            val player = MediaPlayer.create(this, R.raw.correctanswer)
            player.start()
        } else if (button.text.toString() == "فا" && text == "4") {
            binding.textview.text = mylist.random()
            val player = MediaPlayer.create(this, R.raw.correctanswer)
            player.start()
            visible()
        } else if (button.text.toString() == "سل" && text == "5") {
            binding.textview.text = mylist.random()
            val player = MediaPlayer.create(this, R.raw.correctanswer)
            player.start()
            visible()
        } else if (button.text.toString() == "لا" && text == "6") {
            binding.textview.text = mylist.random()
            val player = MediaPlayer.create(this, R.raw.correctanswer)
            player.start()
            visible()
        } else if (button.text.toString() == "سی" && text == "7") {
            binding.textview.text = mylist.random()
            val player = MediaPlayer.create(this, R.raw.correctanswer)
            player.start()
            visible()
